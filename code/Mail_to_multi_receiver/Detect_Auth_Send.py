...
while True:
    nam_jour = input('Please enter the name of the table which contains journal information i.e. aom :')     #期刊信息数据库名  
    try:
        sql = "select * from "+ nam_jour
        cur.execute(sql)
        break
    except: 
        print('You input is invalid, please re-enter the table\'s name again. /n')
        continue
