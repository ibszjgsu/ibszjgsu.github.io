...
url = 'https://www.sciencedirect.com/science/article/pii/S0001457518302112'
t1 = threading.Thread(target=get_url,args=(url,1,get_ip()))
t1.start()
time.sleep(5)  #time.sleep的最小单位是毫秒
#    try:
#       # data = {"bestid": "15616", "score": "5,5,5,5,5,5","source": "best",}
#
#        result = requests.get(url=url, proxies=proxies)  # 跳过证书的验证 verify=False
