...
# =======
#==============================================================================
if not table_exist('JournalofInformetrics'):
    #build a new table named by the journal title 
    sql = "create table JournalofInformetrics (id int not null unique auto_increment, \
...
#==============================================================================
pagenum = 33
pageurl ='http://apps.webofknowledge.com/summary.do?product=WOS&colName=WOS&qid=208&SID=5FCBMinBeC1DwOot6V1&search_mode=GeneralSearch&formValue(summary_mode)=GeneralSearch&update_back2search_link_param=yes&page='



for pg in range(26,pagenum + 1):
...
#  >>>>>>> f1d91706b06feaf187937072f5d89fe7e7267133        
        sql_ins = "insert into JournalofInformetrics (title, authors, au_email, citation, volume, issue, year, url) \
