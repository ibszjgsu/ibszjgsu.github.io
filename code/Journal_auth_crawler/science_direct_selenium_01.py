...
def collect_paper_info(paper_url_in_a_journal):
    ...
    for i, row in paper_url_in_a_journal.iterrows():
        ...
        paper_info = paper_info.append(tmp_info)
    return paper_info              
...
def paper_info_parser(paper_url_list):
    ...
    urls_in_a_journal = paper_url_list['paper_url'].loc[paper_url_list.id == first_valid_id]
...
if __name__ == "__main__":
    ...
    paper_url_list = pd.read_sql_query(sql,engine,index_col = 'index')
